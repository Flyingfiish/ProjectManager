...
namespace ProjectManager.Infrastructure.Repositories.Projects
{
    public class ProjectsRepository //: Repository<Project>, IProjectsRepository
    {
        ...
        //{
        //    ProjectParticipation projectUser = await _context.ProjectUsers.FirstOrDefaultAsync(p => p.UserId == userId);
        ...
        //{
        //    return await _entities
        //        .Include(p => p.Participations).ThenInclude(p => p.User)
        ...
        //{
        //    var team = _context.Teams.Include(t => t.Participations).FirstOrDefault(t => t.Id == teamId);

        //    var participations = new List<ProjectParticipation>();
        //    foreach (var e in team.Participations)
        //    {
        //        participations.Add(new ProjectParticipation()
        //        {
        //            ProjectId = projectId,
        //            TeamId = e.TeamId,
        //            UserId = e.UserId,
